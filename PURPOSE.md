...
> **【2026-07-09 追記・graceful-OOM の producer→classifier 分類 seam を閉包（fix+test+docs）— feedback #3「exit-3→defer/retry」の in-repo producer 側半分・制御系 retry loop 自体は引き続き AI-Hub infra(本 repo 外)】**
