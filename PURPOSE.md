...
> **【2026-07-11 追記・trajectory early-stop の relative-volatility 閾値が best_loss≈0 で崩壊する実 defect を修正（fix+test・mutation 証明）— feedback の「higher-leverage product behavior・DONE 軸再開禁止」原則を、core algorithmic 制御点（early-stop 決定）の実在する信号正しさ欠陥に map して閉じた】**
